          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">
                singh1802jaswant@gmail.com
              </span>

              <a
                href="mailto:singh1802jaswant@gmail.com"
                className="contact__button" target="_"
              >
                Write me
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+91 8502XXXXXX</span>

              <a
                href="https://api.whatsapp.com/send?phone=8502893874&text=Hello, more information!"
                className="contact__button" target="_"
              >
                Write me{" "}
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">@Sjaswant55</span>

              <a href="https://t.me/Sjaswant55" className="contact__button" target="_">
                Write me
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
