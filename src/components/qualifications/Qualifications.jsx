        ...
        <div className="qualification__sections">
          ...
          >
            <div className="qualification__data">
              <div>
                <h3 className="qualification__title">SSC (Perc. : 87.67%)</h3>
                <span className="qualification__subtitle">
                  Divya Adarsh Public, Dhanoo
                </span>
                <div className="qualification__calendar">
                  <i className="uil uil-calendar-alt"></i> 07/2015 - 04/2016
                </div>
              </div>
            ...
            <div className="qualification__data">
              ...
              <div>
                <h3 className="qualification__title"> HSC (Perc : 89.00%)</h3>
                <span className="qualification__subtitle">
                    Mayur Nobles Acadeny, Barmer
                </span>
                <div className="qualification__calendar">
                  <i className="uil uil-calendar-alt"></i> 07/2018 - 03/2019
                </div>
              </div>
            </div>
